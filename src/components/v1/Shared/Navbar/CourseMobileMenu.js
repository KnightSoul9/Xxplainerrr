...
import CourseContent from "../../course/DynamicCourseContent/MainContent/CourseContent";
...
const CourseMobileMenu = ({
  ...
  const courseLink =
    "flex justify-between items-center text-sm hover:bg-blue-400 text-[#3B454E] px-3 ";
